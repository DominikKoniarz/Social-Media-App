...
const Header = () => {
  return (
    <header className="flex ">
      ...
      <LogoText />
      <div className="flex md:flex-row flex-col text-black md:p-0 p-2 text-center  text-sm font-light leading-[14.50px] items-center justify-center md:justify-end w-full">
        Have an account?
        <Link
