        ...
        `}
			...
			<nav
				className={`md:w-[246px] ${
					toggle ? "left-0" : "-left-[9999px]"
				}   absolute md:hidden  z-50 w-[120px] shrink-0 h-full bg-color2 border border-none rounded-r-xl md:rounded-xl overflow-hidden flex flex-col`}
			>
				...
				<span className="max-w-full px-2 pt-2 mx-auto overflow-hidden text-lg font-medium text-white w-fit overflow-ellipsis whitespace-nowrap md:text-xl">
					@{userData?.username}
				</span>
				<LinksList />
				<LogoutButton />
